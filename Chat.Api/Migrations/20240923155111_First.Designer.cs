...
namespace Chat.Api.Migrations
{
    ...
    [Migration("20240923155111_First")]
    partial class First
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Chat.Api.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("8016704a-d330-4da1-91e9-7d981aa8e5bf"),
                            Age = (byte)19,
                            Bio = "Never give up",
                            FirstName = "Asadbek",
                            Gender = "male",
                            LastName = "Shermatov",
                            PasswordHash = "AQAAAAIAAYagAAAAEFeBUzSP7WmzzR1jCsF7QE6XVBAoROJCIqvbN080tUnODq4BeEs9ZsWwZpBdjFmv/Q==",
                            Role = "admin",
                            Username = "spawn"
                        });
                });

            modelBuilder.Entity("Chat.Api.Entities.User_Chat", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
